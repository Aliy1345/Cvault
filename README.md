...
Views: `totalAssets`, `convertToShares`, convertToAssets(shares);
_accrueFees();, `previewDeposit`, `previewWithdraw`, `getAssetList`, `getPendingWithdraw`. All preview views simulate a fee accrual.
